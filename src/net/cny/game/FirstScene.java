...
public class FirstScene extends Scenegraph
{
    ...
    public void Update()
    {
        ...
        {
            background = new GuiBackground("scene/first/background/train_driving.png");
            background.SetTag("nf-train-driving");

            audio = new Audio("scene/first/audio/train_driving.wav");
            audio.Play();

            timer = (int)audio.GetTime() * (int)Main.FRAME_CAP;
